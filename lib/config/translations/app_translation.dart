...
class AppTranslation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en': {
      // --- WELCOME SCREEN ---
      'WELCOME_TITLE': 'Electricity\nBill Tracker',
      'WELCOME_SUBTITLE': 'Track your consumption & save money',
      'FEATURE_TRACK': 'Track your electricity consumption',
      'FEATURE_SAVE': 'Save money with smart insights',
      'FEATURE_INSIGHTS': 'Get detailed analytics & reports',
      'LOGIN': 'Login',
      'CONTINUE_GUEST': 'Continue as Guest',
      'INFO': 'Info',
      'LOGIN_COMING_SOON': 'Login feature coming soon!',
      ...
      'CHART_NO_DATA_SUB':
          'Start adding readings to see your consumption chart',
      ...
      'PERMISSION_MIC_DENIED':
          'Mic permission denied. Please allow it in settings.',
    ...
    'ar': {
      // --- WELCOME SCREEN ---
      'WELCOME_TITLE': 'متتبع\nفاتورة الكهرباء',
      'WELCOME_SUBTITLE': 'تتبع استهلاكك ووفر المال',
      'FEATURE_TRACK': 'تتبع استهلاك الكهرباء الخاص بك',
      'FEATURE_SAVE': 'وفر المال مع رؤى ذكية',
      'FEATURE_INSIGHTS': 'احصل على تحليلات وتقارير مفصلة',
      'LOGIN': 'تسجيل الدخول',
      'CONTINUE_GUEST': 'المتابعة كضيف',
      'INFO': 'معلومة',
      'LOGIN_COMING_SOON': 'ميزة تسجيل الدخول قريباً!',
      ...
      // --- CHART PAGE ---
      'CHART_TITLE': 'الاستهلاك الشهري',
      'CHART_NO_DATA': 'لا توجد بيانات متاحة',
      'CHART_NO_DATA_SUB': 'ابدأ بإضافة القراءات لرؤية مخطط الاستهلاك',
      ...
      // --- UTILITY/VOICE/OCR KEYS (ReadingUtils) ---
      'PERMISSION_MIC_DENIED':
          'تم رفض إذن الميكروفون. يرجى السماح به في الإعدادات.',
